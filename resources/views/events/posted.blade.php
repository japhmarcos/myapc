                ...
                <div class="col-md-4">
                    <div class="panel panel-default">                            
                        ...
                        <div class="panel-body">
                            ...
                            <div class="post-date"><span class="fa fa-calendar"></span>&nbsp;&nbsp;&nbsp;{{ date("F d, Y", strtotime($epost->date_start)) }} | <span class="fa fa-user"></span> by {{$epost->author->first_name}}</div>
                            ...
                            <div class="post-date">&nbsp;<span class="fa fa-users"></span><strong>&nbsp;&nbsp;{{$epost->attendee->count()}} Attendees</strong></div>  
                        ...
                        <div class="panel-footer text-muted">
                            <form class="form-horizontal" role="form" method="POST" action="/events/posted" enctype="multipart/form-data" onsubmit="return confirm('Are you sure you want to delete?')">
                                ...
                                <span class="fa fa-clock-o"></span> Created {{\Carbon\Carbon::createFromTimeStamp(strtotime($epost->created_at))->diffForHumans()}} 
